...
\section{Pré-processamento e integração dos dados}\label{sec:pre-processamento}
	...
	Em seguida, sereá realizada a padronização espacial, especialmente necessária para integração entre dados em grade (TSM e reanálise) e dados pontuais (estações meteorológicas).
