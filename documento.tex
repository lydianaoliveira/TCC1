...
\autor{Lydiana Rodrigues de Oliveira}
\titulo{Ondas de calor marinhas no Atlântico Sul e extremos hidroclimáticos no Sul do Brasil: uma análise de teleconexões baseada em aprendizado de máquina}
\data{2025}
\local{Fortaleza}
